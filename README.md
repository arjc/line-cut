...
![Christmas theme line cut match 3](https://github.com/arjc/line-cut/tblob/main/thumb-git.png?raw=true)

## how to play
Play as per the instructions provided on the game screen 

## About 
Line cut is a silly litte candy crush knockoff that I made inspired by a discontinued game called flappy creator...
Like flappy creator I wanted users to create new skin/version of the game where you can add your own assets and share it with your friends. It's a silly little idea that I had, and I could work on my web dev skills and game making skills.
